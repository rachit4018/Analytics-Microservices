...
# loggin.Formatter is a class that formats log records.
# We will create a custom formatter that outputs logs in JSON format.
...
def setup_logging(level: str = "INFO") -> None:
    ...
    handler.setFormatter(
        JSONFormatter()
    )  # Set the custom JSON formatter for the handler
